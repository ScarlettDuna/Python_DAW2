...
# Eliminamos dobles comillas y espacios antes y después del string
...
# Intersección entre los dos set (los items iguales entre ambos) y los ordena
distritos = np.array(sorted(set(distritos_parques) & set(distritos_censo)))
print(distritos)

# Parques por distritos - list comprehension
